...
import { ArrowRight, ChevronRight , Zap, UserIcon, Twitter, Facebook, Linkedin} from "lucide-react";
import Link from "next/link";
import { Button } from "@/components/ui/button";
import Marquee from "@/components/ui/marquee";
import { BorderBeam } from "@/components/ui/border-beam";
import SectionBadge from "@/components/ui/section-badge";
import { features, pricingCards, reviews } from "@/constants";
...
const HomePage = () => {
    ...
    return (
        <section className="w-full relative flex flex-col items-center justify-center px-4 md:px-0 py-8">
                    ...
                    <div className="flex flex-col items-center justify-center py-20 w-full">
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1.5">
                                ...
                                Welcome to Tracecafé
                                <ChevronRight className="w-4 h-4" />
                            </span>
                        </button>
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                            Track the origin of coffee, from farm to cup.
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                 Our platform empowers coffee producers to share detailed information behind each batch, ensuring transparency from farm to cup. Enjoy your coffee with trust and a deeper connection to its journey.
                            </p>
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                                    <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                        ☕️ {"  "} Trace your coffee's journey from farm to cup now
                                    </p>
            ...
            <Wrapper className="fles flex-col items-center justify-center py-12 relative">
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        <SectionBadge title="Our Customers" />
                           ...
                           <p className="text-muted-foreground mt-6">
                            See how Tracecafé empowers businesses of all sizes. Here&apos;s what real people are saying on Twitter
                        </p>
                    </div>
                </Container>
                <Container>
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
                            <div className="flex flex-col items-start gap-4 w-full">
                                ...
                                <p className="text-base text-muted-foreground">
                                    Be up to date with everything about Tracecafé
                                </p>
                            </div>
